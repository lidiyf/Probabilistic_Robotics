...
class NavigationGoal(NavigationTrack):
    ...
    def _init_obstacles(self) -> None:
        for _ in range(self._N_OBSTACLES):
            ...
            # print(self._world)
            # self._world.append(1)
            self._world.append(Line(point1, point2))
            self._world.append(Line(point2, point3))
            self._world.append(Line(point3, point4))
            self._world.append(Line(point4, point1))
